# Generated by Django 4.1 on 2023-05-05 15:32
...
def add_customer_data(apps, schema_editor):
    customer_class = apps.get_model('usedcarinfo', 'Customer')
    for customer in CUSTOMERS:
        try:
            duplicate_object = customer_class.objects.get(
                first_name=customer['first_name'],
                last_name=customer['last_name'],
                disambiguator=customer['disambiguator']
            )
            print('Duplicate customer entry not added to customer table:', customer['first_name'], customer['last_name'])
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("usedcarinfo", "0007_load_dealer_test_data"),
    ]
